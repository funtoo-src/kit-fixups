...
async def generate(hub, **pkginfo):
	slots = [
		("7.4", "7.4.28", ["php-iodbc-header-location.patch", "apache.patch", "bug81656-gcc-11.patch"], None),
		("8.0", "8.0.16", ["php-iodbc-header-location.patch", "php80-firebird-warnings.patch"], None),
		("8.1", "8.1.3" , ["php-iodbc-header-location.patch"], None),
	]
